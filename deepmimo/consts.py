...
SUPPORTED_SIONNA_VERSIONS = ["0.19.1", "0.19.2", "1.0.2", "1.1.0", "2.0.0", "2.0.1"]  # Expand to 1.0.x
...
AOD_EL_FOV_PARAM_NAME = (
    "_aod_el_rot_fov"  # Elevation angles after rotation and FoV filtering (radians)
)
AOD_AZ_FOV_PARAM_NAME = (
    "_aod_az_rot_fov"  # Azimuth   angles after rotation and FoV filtering (radians)
)
AOA_EL_FOV_PARAM_NAME = (
    "_aoa_el_rot_fov"  # Elevation angles after rotation and FoV filtering (radians)
)
AOA_AZ_FOV_PARAM_NAME = (
    "_aoa_az_rot_fov"  # Azimuth   angles after rotation and FoV filtering (radians)
)
